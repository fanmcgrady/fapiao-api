...
# 矫正 -> 行提取
def surface(filename, typeP='blue'):
    filepath = os.path.join('allstatic', filename)
    print("surface begin", filename)
    ...
    if typeP == None:
        ...
        if typeP == 'blue' or typeP == 'excess':
            # return out_filename, 1, pipe.textlines, cdic
            print("-----------------")
            midProcessResult = PipeInvoice.getPipe('allstatic', filename, typeP, False)
            print("+++++++", midProcessResult)
        else:
            ##type == 'red'
    ...
    """
    attributeLine = midProcessResult[3]
    print("attributeline:\n",attributeLine) 
    # 生成行提取的图片
    plt_rects = []
...
if __name__ == "__main__":
    ...
    #    im = cv2.imread("/home/organize/Image_00102.jpg")
    #    print("im readed")
    #    js, origin = init("/home/organize/Image_00102.jpg", "blue")
    #    print("js= "+str(js)+" "+"origin= "+str(origin))
    #    print("/home/organize/Image_00102.jpg")
    js, origin = init("/home/ocr/fapiao-api/allstatic/upload/20190728172533.jpg" ,"blue")
    print("js= "+str(js)+" "+"origin= "+str(origin))
